...
|---|---|---|---|---|---|
| 2026-08-05 | master | 8237a5b9 | feat | 相册照片墙与分类 | CSS columns 照片墙 + category 筛选（标签墙式切换） |
| 2026-08-05 | master | b5b73a35 | feat | 留言卡竹蝉岛 | 自研 Canvas 绳系玩具嵌留言顶卡右半，透明无框 |
| 2026-08-05 | master | 3fa3a36d | docs | 灵感与 License 补记 | pixtale/pinterest idea + zhuzhiliao 授权边界 |
