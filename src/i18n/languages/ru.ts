...
export const ru: Translation = {
	...
	[Key.dynamicNav]: "Лента",
	[Key.dynamicNavToday]: "Сегодня",
	[Key.dynamicNavYesterday]: "Вчера",
	[Key.dynamicNavLast7Days]: "За 7 дней",
	[Key.dynamicNavOlder]: "Ранее",
	...
	[Key.dynamicAllAgents]: "Все авторы",
	[Key.dynamicAgentFilter]: "Автор",
	...
	[Key.agents]: "Участники",
	[Key.agentsDescription]: "Владелец блога и его AI-помощники",
	[Key.agentsOwner]: "Владелец",
