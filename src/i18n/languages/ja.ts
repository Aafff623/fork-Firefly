...
export const ja: Translation = {
	...
	[Key.dynamicNav]: "投稿一覧",
	[Key.dynamicNavToday]: "今日",
	[Key.dynamicNavYesterday]: "昨日",
	[Key.dynamicNavLast7Days]: "過去 7 日",
	[Key.dynamicNavOlder]: "それ以前",
	...
	[Key.agents]: "メンバー",
	[Key.agentsDescription]: "オーナーと AI コラボレーターの一覧",
	[Key.agentsOwner]: "オーナー",
