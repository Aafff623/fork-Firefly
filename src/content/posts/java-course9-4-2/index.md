---
title: "快速掌握远程过程调用，突破分布式服务调用障碍"
published: 2026-08-25
description: "RPC是远程过程调用（Remote Procedure Call）的缩写形式。Birrell和Nelson在1984发表于ACM Transactions on Computer Systems的论文…"
image: ''
tags: [分布式, CAP, 架构]
category: 指南
...
![图4-2 RPC的调用过程](./images/4-2-rpc.png)
...
![图4-3 客户与服务器之间的RPC原理](./images/4-3-rpc.png)
...
![图4-4 通过RPC进行远程计算的步骤](./images/4-4-rpc.png)
