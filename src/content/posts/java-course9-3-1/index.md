---
title: "线程与进程原理解析，高并发应用的基石"
published: 2026-08-25
description: "在早期的计算机操作系统中，能拥有资源和独立运行的基本单位是进程。然而随着计算机技术的发展，进程出现了很多弊端，一是由于进程是资源拥有者，创建、撤消与切换存在较大的时空开销，因此需要引入轻量型进程；二是…"
image: ''
tags: [分布式, CAP, 架构]
category: 指南
...
![图3-1 线程的状态图](./images/3-1-thread-states.png)
