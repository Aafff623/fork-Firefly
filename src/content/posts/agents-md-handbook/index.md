---
title: 写好 AGENTS.md：六场景模板，少让 Agent 走偏
published: 2026-08-10
updated: 2026-08-12
description: AGENTS.md 六场景模板，以及对照 CLAUDE.md：写给人的 README 为什么不够。
image: ./cover.jpg
tags: [AGENTS.md, Codex, Agent, 规范]
category: 指南
collections: [agentic-coding-core]
draft: false
lang: ''
slug: agents-md-handbook
pinned: false
comment: true
---
...
> 合并自原帖 `agents-md-handbook`

一份好的 `AGENTS.md`，不会让 Codex 突然变得更聪明，却会显著减少它在错误方向上越走越远。

Claude Code 侧同类文件见 [CLAUDE.md 模板专篇](/posts/claude-md-handbook/)；四类 Loop 见 [Claude Code 四类 Loop](/posts/claude-code-handbook/)。
...
![Codex 如何按层级加载 AGENTS.md](./images/agents-md-template-six-scenes/fig-01-01-codex-agents-layer-loading.jpg)

这也是写好 `AGENTS.md` 的第一个关键：不要试图用一份巨型文件解释整个世界，要让规则跟着代码的边界走。

### 二、六条原则

![高质量 AGENTS.md 的六大原则](./images/agents-md-template-six-scenes/fig-02-02-agents-six-principles.jpg)
...
![AGENTS.md 模板七段](./images/agents-md-template-six-scenes/fig-03-03-agents-template-seven-sections.jpg)
...
![六场景局部规则](./images/agents-md-template-six-scenes/fig-04-04-agents-six-scenario-local-rules.jpg)
...
- [agents.md](https://agents.md) 已由 Agentic AI Foundation（Linux Foundation）托管
- Codex 可用 /init 生成 AGENTS.md 草稿，须按真实构建/测试改
- 不可逆操作要配合权限/sandbox，不要只靠说明书
