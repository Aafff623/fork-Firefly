...
- [告别塑料感：哑光纸、偏心视窗、巨型裁切字](../2026-08-10_告别塑料感_巨型裁切字海报/告别塑料感：哑光纸、偏心视窗、巨型裁切字.md)
- [Coze 历史人物科普海报](../2026-08-10_Coze历史人物科普海报工作流/输入一个名字：Coze三十秒出历史人物科普海报.md)

---

## 脚注

1. **套数**：文称 36 套；本次从 6 张配图可辨 **36** 套（每风格 6）。完整物料作者称可后台获取——评论区「666 / 私信收徒」引流，**不录入正文**。
2. **图面文字不清 / 待核**
   - 炽羽凰姬提示词倒数第二组：OCR 在「凤眸高贵」与「凤舞高贵」间不一致，未写入表内定稿。
   - 雪溪刀客「白衣披白」：字形如此抄录；近似「披帛」时以原图像素为准。
   - 莲灯壁画仙姬：是否含「壁画**风**」一字，多轮 OCR 略有出入；表内暂留「壁画风仙姬」。