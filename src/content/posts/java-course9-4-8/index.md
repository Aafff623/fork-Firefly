---
title: "理解分布式下的事件驱动，突破同步编程思维定式"
published: 2026-08-25
description: "在GUI编程中，事件是非常常见的。比如，用户在界面点击了按钮，就会发送一个“点击”事件，而相应的会有一个处理“点击”事件的事件处理器会来处理该事件。因此，"
image: ''
tags: [分布式, CAP, 架构]
category: 指南
...
![图4-11 事件循环的工作示例图](./images/4-11-event-loop.png)
...
![图4-12 Reactor示意图](./images/4-12-reactor.png)
...
![图4-13 Reactor序列图](./images/4-13-reactor.png)
...
![图4-14 Proactor示意图](./images/4-14-proactor.png)
