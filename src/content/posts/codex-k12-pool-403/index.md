---
title: K12 号池喂给 Codex：一次 403 的刨根问底
published: 2026-08-06
description: 代理 URL、被写死的 priority 档、名不副实的"10 个号"——三层问题叠一起，把 Codex 卡到吐不出一个字。控制变量实测，逐个揪出来。
image: ./cover.jpg
tags: [Codex, K12, 中转, 排错, AI Coding]
category: 中转
...
pinned: false
comment: true
updated: 2026-08-06T23:21:53
---

起因特别朴素：GPT 桌面端和 Codex CLI 一起"吐不出字"，报 `403 codex_workspace_access_denied` 或者 `502 no auth available`。本以为是号商账号的问题，查到最后发现是三层问题叠在一起，其中一层反直觉到让人拍桌子。这篇把三层都摊开，中间几次被事实打脸的地方也留着，比顺理成章的教程有用。
