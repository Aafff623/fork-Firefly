---
title: "修改不可变集合导致UnsupportedOperationException错误分析"
published: 2026-08-25
description: "运行应用，试图保存笔记修改后的数据时，报错如下图10-1所示。"
image: ''
...
![图10-1 访客的视角的笔记详情界面效果](./images/10-1.png)
...
![图10-2 笔记编辑页面](./images/10-2.png)


下图10-3所示的是笔记编辑成功后的页面。


![图10-3 笔记编辑成功后的页面](./images/10-3.png)
