...
旁链（**不硬并**）：容器层命令见 [Docker 命令背会这条线就够日常](../2026-08-10_Docker高频命令速查/Docker命令背会这条线就够日常.md)；运维工具选型见 [运维自动化选型：先摸清这十件工具](../2026-08-10_运维必须知道的十大自动化工具/运维自动化选型：先摸清这十件工具.md)。网络基础旁链文末。
...
| 旁链 | 它管啥 | 别跟本篇混 |
|---|---|---|
| [Docker 命令背会这条线就够日常](../2026-08-10_Docker高频命令速查/Docker命令背会这条线就够日常.md) | Docker CLI | 单机容器命令 ≠ 集群编排 |
| [运维自动化选型：先摸清这十件工具](../2026-08-10_运维必须知道的十大自动化工具/运维自动化选型：先摸清这十件工具.md) | 运维工具地图 | 工具选型 ≠ K8s 控制面 |
| [网络协议靠谁才能活：一张依赖图](../2026-08-10_网络协议依赖关系一览/网络协议靠谁才能活：一张依赖图.md) | 协议依赖 | 协议栈 ≠ CNI/Service 排障 |
| [网卡那四栏到底各自干嘛](../2026-08-09_计算机网络基础四件套/网卡那四栏到底各自干嘛.md) | 网络基础四栏 | 基础课 ≠ 集群网络架构图 |
| [Linux 目录结构运维速记](../2026-08-10_Linux目录结构运维速记/Linux目录结构运维速记.md) | 主机目录 | Node 侧速记 ≠ 编排模型 |
