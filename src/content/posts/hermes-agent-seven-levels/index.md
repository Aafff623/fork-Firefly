---
title: Hermes 别只装个壳：七层装修到无限记忆
published: 2026-08-11
updated: 2026-08-11T01:39:19
description: 把 Hermes 当 7×24 独立电脑：VPS、入口、Curator、备份、看板、Holographic 记忆、暴露成 MCP。附录一张双端斜杠命令速查。
image: ./cover.jpg
tags: [Hermes, Agent, 记忆, MCP, 运维, 斜杠命令]
category: Agentic Coding
draft: false
lang: ''
slug: hermes-agent-seven-levels
pinned: false
comment: true
---
...
![7 Levels of Hermes Agent](./images/fig-01-seven-levels.jpg)
...
「MCP ≠ Skills」那篇讲层位（同批草稿 [`mcp-vs-skills-layers`](/posts/mcp-vs-skills-layers/)）；本层讲的是 **Hermes 如何成为被调用的那一端**。改完 MCP 配置记得 `/reload-mcp`。
...
![Hermes Agent 斜杠命令速查](./images/fig-02-slash-commands.jpg)
