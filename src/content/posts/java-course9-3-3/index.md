---
title: "节点之间的通信，构建低延迟高可靠的通信链路"
published: 2026-08-25
description: "节点与节点之间是完全独立、相互隔离的，节点之间传递信息的唯一方式是通过网络进行通信。而网络往往是不可靠的，即一个节点可以向其他节点通过网络发送消息，但发送消息的节点无法确认消息是否被接收节点完整正确收…"
image: ''
tags: [分布式, CAP, 架构]
category: 指南
