...
同日另一份开源盘点是六月口径的 17 条，题材近、体裁不同 → 旁链不硬并（待发布）。

---

## 1 · vitali87/code-graph-rag

![vitali87/code-graph-rag · 代码图谱读懂大型仓库](./images/fig-01-01_vitali87_code-graph-rag.jpg)
...
![google-deepmind/weathernext · 全球天气开放预测代码](./images/fig-02-02_google-deepmind_weathernext.jpg)
...
![Comfy-Org/ComfyUI · 图像生成拆成节点流程](./images/fig-03-03_comfy-org_comfyui.jpg)
...
![harveyai/harvey-labs · 法律 Agent 开始统一考试](./images/fig-04-04_harveyai_harvey-labs.jpg)
...
![PrimeIntellect-ai/prime-agent · 长任务 Agent 学会续跑](./images/fig-05-05_primeintellect-ai_prime-agent.jpg)
...
![pranshuparmar/witr · 幽灵进程谁启动的](./images/fig-06-06_pranshuparmar_witr.jpg)
...
![addyosmani/agent-skills · 工程经验装进技能包](./images/fig-07-07_addyosmani_agent-skills.jpg)
...
![ZhuLinsen/daily_stock_analysis · 多市场行情自动做日报](./images/fig-08-08_zhulinsen_daily_stock_analysis.jpg)
...
![goauthentik/authentik · 一套登录接管内部应用](./images/fig-09-09_goauthentik_authentik.jpg)
...
![google/skills · 云端操作写成 Agent 技能](./images/fig-10-10_google_skills.jpg)
...
![pingdotgg/t3code · 多个编码 Agent 一个控制台](./images/fig-11-11_pingdotgg_t3code.jpg)
