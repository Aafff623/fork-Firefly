...
想压住镜头节奏，另看运镜词库；想从成图反推关键词，另看反推公式。本篇只解决「这张脸该长什么样」。

---

## 旁链（相关但不并卷）

- [古风女主别再写「汉服长发」：六风格三十六套提示词](../2026-08-10_古代女子服饰六风格提示词/古风女主别再写汉服长发：六风格三十六套提示词.md)（女装古风 ≠ 男主短剧脸）
- [人物场景再精致，固定机位也只是会说话的插画](../2026-08-10_AI漫剧运镜提示词36种/人物场景再精致，固定机位也只是会说话的插画.md)（运镜 ≠ 脸型）
- [看到好图别跪求 Prompt：按维拆完就能反推](../2026-08-10_AI图片提示词反推公式/看到好图别跪求Prompt按维拆完就能反推.md)（反推方法 ≠ 脸型词库）
...
1. **套数**：文称 60 种；本次从 10 张配图可辨 **60** 款（每图 6，编号 01–60 连续）。评论区招生引流（如「888」）**不录入正文**。
2. **缺失项**：评论有人问「大叔提示词」——原文未给，本笔记不补编。
3. **图面文字核对**
   - **51 适合角色**：多轮 OCR 在「狠系男主角色」与「狠系男主角角色」间略有出入；定稿取「狠系男主角色」（「狠」非「狼」）。
   - **52 风格名**：图面为「斯文败类**类型**脸」（含「类型」二字），照抄不删。
   - **56 风格名**：「漫撕贵公子脸」图面可辨，保留「漫撕」。
   - **59**：风格名用「狠**戾**」，角色栏用「狠**厉**」——图面本身用字不同，非笔误统一。