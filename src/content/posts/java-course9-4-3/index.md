---
title: "掌握常用网络I/O模型，建立系统级性能优化思维"
published: 2026-08-25
description: "I/O操作主要是操作系统来完成的。根据UNIX的设计，共有五种类型的I/O模型"
image: ''
tags: [分布式, CAP, 架构]
category: 指南
...
![图4-5 阻塞I/O模型](./images/4-5-io.png)
...
![图4-6 非阻塞I/O模型](./images/4-6-io.png)
...
![图4-7 I/O复用模型](./images/4-7-io.png)
...
![图4-8 信号驱动I/O（SIGIO）模型](./images/4-8-io.png)
...
![图4-9 异步I/O模型](./images/4-9-io.png)
...
![图4-10 异步I/O模型](./images/4-10-io.png)
