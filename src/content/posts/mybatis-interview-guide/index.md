...
## 1.1 MyBatis 是什么
![plan-mybatis-overview-h2-01](./images/plan-mybatis-overview-h2-01.png)
...
![plan-mybatis-overview-h2-02](./images/plan-mybatis-overview-h2-02.png)
...
![plan-mybatis-overview-h2-03](./images/plan-mybatis-overview-h2-03.png)
...
## 二、核心配置与使用
![plan-mybatis-h1-01](./images/plan-mybatis-h1-01.png)

## 2.1 使用步骤
![plan-mybatis-h1-01-h2-01](./images/plan-mybatis-h1-01-h2-01.png)
...
## 2.2 组件生命周期
![plan-mybatis-h1-01-h2-02](./images/plan-mybatis-h1-01-h2-02.png)
...
## 2.3 传递多个参数
![plan-mybatis-h1-01-h2-03](./images/plan-mybatis-h1-01-h2-03.png)
...
## 2.4 实体类属性与字段名不一致
![plan-mybatis-h1-01-h2-04](./images/plan-mybatis-h1-01-h2-04.png)
...
## 2.5 枚举映射
![plan-mybatis-h1-01-h2-05](./images/plan-mybatis-h1-01-h2-05.png)

默认 MyBatis 不认识枚举，需要配置 `typeHandler` 作为翻译官。例如枚举 `STATUS_ENABLED` 存库转数字 1，查出来转回枚举对象。

## 2.6 #{} 与 ${} 的区别（面试高频）
![plan-mybatis-h1-01-h2-06](./images/plan-mybatis-h1-01-h2-06.png)
...
## 2.7 模糊查询 LIKE 写法
![plan-mybatis-h1-01-h2-07](./images/plan-mybatis-h1-01-h2-07.png)

推荐写法：`like concat('%', #{name}, '%')`，使用 `#{}` 安全且数据库兼容（MySQL、Oracle 均可）。不推荐：`like '%${name}%'`，容易 SQL 注入。

## 2.8 获取生成主键
![plan-mybatis-h1-01-h2-08](./images/plan-mybatis-h1-01-h2-08.png)
...
## 2.9 全局配置 settings
![plan-mybatis-h1-01-h2-09](./images/plan-mybatis-h1-01-h2-09.png)

常用配置：`mapUnderscoreToCamelCase` 设为 `true`，数据库下划线字段自动映射为 Java 驼峰属性，省去 resultMap，大部分场景够用。其他常用配置有：日志实现、延迟加载开关等，需有印象。

## 三、动态 SQL
![plan-mybatis-h1-02](./images/plan-mybatis-h1-02.png)

## 3.1 动态 SQL 概述
![plan-mybatis-h1-02-h2-01](./images/plan-mybatis-h1-02-h2-01.png)

业务需求灵活，用户可能填也可能不填参数。动态 SQL 允许在 XML 中写 if/else、循环，根据传入参数自动拼出不同 SQL。

## 3.2 常用动态 SQL 标签
![plan-mybatis-h1-02-h2-02](./images/plan-mybatis-h1-02-h2-02.png)
...
## 3.3 foreach 标签属性
![plan-mybatis-h1-02-h2-03](./images/plan-mybatis-h1-02-h2-03.png)
...
## 3.4 OGNL 表达式
![plan-mybatis-h1-02-h2-04](./images/plan-mybatis-h1-02-h2-04.png)

写在 `test=""` 中的取值语法，直接从传入 Java 对象中获取属性，如 `test="title != null"` 自动取 title 属性，无需写 getter。它是动态 SQL 的“眼睛”，判断是否拼接 SQL 片段。

## 四、缓存机制
![plan-mybatis-h1-03](./images/plan-mybatis-h1-03.png)

## 4.1 一级缓存
![plan-mybatis-h1-03-h2-01](./images/plan-mybatis-h1-03-h2-01.png)
...
## 4.2 二级缓存
![plan-mybatis-h1-03-h2-02](./images/plan-mybatis-h1-03-h2-02.png)
...
## 4.3 共享缓存
![plan-mybatis-h1-03-h2-03](./images/plan-mybatis-h1-03-h2-03.png)

多个 Mapper 共用一块缓存，使用 `<cache-ref namespace="..."/>` 标签，把几个小公告栏合并成大公告栏。

## 五、插件、拦截器与分页
![plan-mybatis-h1-04](./images/plan-mybatis-h1-04.png)

## 5.1 插件原理与四大对象
![plan-mybatis-h1-04-h2-01](./images/plan-mybatis-h1-04-h2-01.png)
...
## 5.2 插件编写步骤
![plan-mybatis-h1-04-h2-02](./images/plan-mybatis-h1-04-h2-02.png)
...
## 5.3 插件常用场景
![plan-mybatis-h1-04-h2-03](./images/plan-mybatis-h1-04-h2-03.png)
...
## 5.4 分页机制
![plan-mybatis-h1-04-h2-04](./images/plan-mybatis-h1-04-h2-04.png)
...
## 六、工作原理与动态代理
![plan-mybatis-h1-05](./images/plan-mybatis-h1-05.png)

## 6.1 工作原理概述
![plan-mybatis-h1-05-h2-01](./images/plan-mybatis-h1-05-h2-01.png)
...
## 6.2 功能架构
![plan-mybatis-h1-05-h2-02](./images/plan-mybatis-h1-05-h2-02.png)
...
## 6.3 Mapper 接口与动态代理
![plan-mybatis-h1-05-h2-03](./images/plan-mybatis-h1-05-h2-03.png)
...
## 七、关联查询与延迟加载
![plan-mybatis-h1-06](./images/plan-mybatis-h1-06.png)

## 7.1 一对一关联 association
![plan-mybatis-h1-06-h2-01](./images/plan-mybatis-h1-06-h2-01.png)
...
![plan-mybatis-h1-06-h2-02](./images/plan-mybatis-h1-06-h2-02.png)
...
## 7.3 延迟加载
![plan-mybatis-h1-06-h2-03](./images/plan-mybatis-h1-06-h2-03.png)

懒加载：查订单时不立刻查用户信息，等真正调用 `order.getUser().getName()` 时才发 SQL 查询。好处是省内存和带宽。原理是 MyBatis 返回的不是真实对象，而是代理对象，一调用方法才去查库。

## 7.4 嵌套查询与嵌套结果
![plan-mybatis-h1-06-h2-04](./images/plan-mybatis-h1-06-h2-04.png)
...
## 八、面试常考点补充
![plan-mybatis-h1-07](./images/plan-mybatis-h1-07.png)

## 8.1 默认别名
![plan-mybatis-h1-07-h2-01](./images/plan-mybatis-h1-07-h2-01.png)

MyBatis 为常见类型预设别名：`int`→`Integer`、`string`→`String`、`list`→`List`、`map`→`Map` 等，简化配置文件中的类型引用。

## 8.2 resultMap 高级用法
![plan-mybatis-h1-07-h2-02](./images/plan-mybatis-h1-07-h2-02.png)
...
## 8.3 ObjectFactory
![plan-mybatis-h1-07-h2-03](./images/plan-mybatis-h1-07-h2-03.png)

MyBatis 查完数据创建对象时默认使用无参构造器。如果实体类只有带参构造器或需工厂模式创建，需自定义实现 `ObjectFactory` 接口，告诉 MyBatis 按自己的规矩造对象。

## 8.4 环境配置与映射器注册
![plan-mybatis-h1-07-h2-04](./images/plan-mybatis-h1-07-h2-04.png)
...
## 8.5 与 Spring 集成
![plan-mybatis-h1-07-h2-05](./images/plan-mybatis-h1-07-h2-05.png)
...
## 8.6 日志配置
![plan-mybatis-h1-07-h2-06](./images/plan-mybatis-h1-07-h2-06.png)

MyBatis 支持多种日志框架。配置 `logImpl=STDOUT_LOGGING` 后，控制台直接打印带参数的真实 SQL，方便排查错误。

## 8.7 Batch 模式注意事项
![plan-mybatis-h1-07-h2-07](./images/plan-mybatis-h1-07-h2-07.png)

开启 `ExecutorType.BATCH` 批量插入时，事务提交前拿不到自动生成主键 id。如果急需 id 做其他操作（如插入明细表），不要用 Batch 模式，应逐条插入或查回。

## 8.8 延迟加载触发方法
![plan-mybatis-h1-07-h2-08](./images/plan-mybatis-h1-07-h2-08.png)
...
## 8.9 存储过程支持
![plan-mybatis-h1-07-h2-09](./images/plan-mybatis-h1-07-h2-09.png)
...
## 8.10 数据库移植性
![plan-mybatis-h1-07-h2-10](./images/plan-mybatis-h1-07-h2-10.png)

手写 SQL 如 `LIMIT 0,10` 是 MySQL 独有，换到 Oracle 或国产达梦可能报错。若项目明确需适配多数据库，可考虑 MyBatis-Plus，它内置多数据库方言适配。

## 8.11 MyBatis-Plus
![plan-mybatis-h1-07-h2-11](./images/plan-mybatis-h1-07-h2-11.png)
...
## 8.12 命名空间
![plan-mybatis-h1-07-h2-12](./images/plan-mybatis-h1-07-h2-12.png)

`namespace` 必须等于 Mapper 接口全限定类名，MyBatis 才能通过动态代理找到对应 XML。同时它是二级缓存的隔离隔间，每个 namespace 有自己的缓存；共享时使用 `<cache-ref>` 标签跨隔间取数据。

## 8.13 面试回答示例
![plan-mybatis-h1-07-h2-13](./images/plan-mybatis-h1-07-h2-13.png)
