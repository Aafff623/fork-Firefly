---
title: Kiro 里的 Claude，为啥老觉得被套了缰绳
published: 2026-08-08
updated: 2026-08-08T22:58:00
description: 选了 Claude，开口却像另一个人。不是模型变笨，是 Kiro 的 Agent Harness 先套了一层规矩。泄露 prompt、#7792、官方 harness 博文都指向同一结论。
image: ./cover.jpg
tags: [Kiro, Claude, Agent Harness, Spec-driven, 系统提示词]
category: Agentic Coding
draft: false
lang: ''
slug: kiro-claude-harness-feel
pinned: false
comment: true
---
...
![Kiro Spec：Requirements → Design → Tasks 任务树](./images/fig-specs.jpg)
...
![模型选择器：同一壳子可挂多款模型](./images/fig-models.jpg)
