---
title: "理解本地过程调用，初步掌握分布式体系调用技巧"
published: 2026-08-25
description: "进程间通信（Inter-Process Communication，IPC）指至少两个进程或线程间传送数据或信号的一些技术或方法。进程是计算机系统分配资源的最小单位。每个进程都有自己的一部分独立的系统…"
image: ''
tags: [分布式, CAP, 架构]
category: 指南
...
![图4-1 LPC的调用过程](./images/4-1-lpc.png)
