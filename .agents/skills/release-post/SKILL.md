...
| 位置 | 用途 |
|---|---|
| `Firefly/.agents/skills/release-post` | 仓内 Agent / Codex 系发现 |
| `blog/.cursor/skills/release-post` | 工作区根为上一级 `blog/` 时 |
| `~/.agents/skills/release-post` | 全局 agents |
| `~/.claude/skills/release-post` | Claude Code |
| `~/.cursor/skills/release-post` | Cursor 全局 skills |
